    ...
    <>
      ...
      <div className="relative max-w-3xl mx-auto rounded-3xl overflow-hidden bg-white shadow-lg mt-4">
        ...
        <div className="bg-white p-6 -mt-12 relative z-10">
          ...
          <div className="mt-3">
            ...
            <button onClick={() => handlePayment(19.90, 'Vitalício')} className="w-full subscription-gradient text-black py-4 px-6 rounded-2xl font-medium transition-all mb-2 flex justify-between items-center shadow-sm">
              <span>Vitalício</span>
              <span>R$ 19,90</span>
            </button>
          </div>
      ...
      <div className="max-w-3xl mx-auto mt-4">
        <div className="bg-white rounded-3xl shadow-lg p-1">
          <div className="flex">
            <div onClick={() => setActiveTab('posts')} className="flex-1 flex items-center justify-center py-4 px-6 cursor-pointer hover:bg-gray-50 transition-colors">
              <div className="flex items-center space-x-2">
                <svg className="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                </svg>
                <span className="text-gray-600 font-medium">513 Postagens</span>
              </div>
            </div>
            
            <div onClick={() => setActiveTab('medias')} className="flex-1 flex items-center justify-center py-4 px-6 cursor-pointer hover:bg-gray-50 transition-colors">
              <div className="flex items-center space-x-2">
                <svg className="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"></path>
                </svg>
                <span className="text-gray-600 font-medium">159 Mídias</span>
              </div>
            </div>
          </div>
        </div>
